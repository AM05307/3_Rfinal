...
public class PropertyVo {
	...
	public double getSuic() {
		return suic;
	}
	public void setSuic(double suic) {
		this.suic = suic;
	}
	@Override
	public String toString() {
		return "AptVo [sigungu=" + sigungu + ", bunji=" + bunji + ", bonbeon=" + bonbeon + ", bubeon=" + bubeon
				...
				+ doromyung + ", c_type=" + c_type + ", hit=" + hit + ", suic=" + suic + "]";
	}
