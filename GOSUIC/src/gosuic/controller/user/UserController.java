...
public class UserController {
	...
	public ModelAndView login(HttpServletRequest request, HttpServletResponse response, HttpSession session, UserVo vo)
			throws IOException {
	...
	public ModelAndView deleteat_Property(HttpSession session, HttpServletRequest request, Model model) {
		...
		int row = userService.deleteat_Property(userEmail, pv);
		System.out.println("로값:" + row);

		mav.setViewName("forward:/mypage.sp");
