		...
		<div class="container">
			...
			<form action="/GOSUIC/insertUser.sp" method="post">
				...
				<label for="email">Email</label> <input type="email"
					...
					placeholder="example@example.com"> <input type="button"
					id="idcheck" value="아이디 중복검사"> <label for="id">아이디</label>
				<input type="text" class="form-control" id="userID" name="userID"
					placeholder="최대16자(영소문자,숫자만가능)" maxlength="20"> <label
					for="password">비밀번호</label> <input type="password"
					class="form-control" id="password1" name="password1"
					placeholder="최소6자이상, 최대16자이하(영소문자,숫자,특수문자 1개이상 포함)"> <label
					for="password">비밀번호확인</label> <input type="password"
					class="form-control" id="password2" name="password2"
					onkeyup="passwordCheckFunction();" placeholder="동일한 비밀번호를 입력하시오">
				<h5 style="color: red;" id="passwordCheckMessage"></h5>

				<label for="name">이름(실명)</label> <input type="text"
					class="form-control" id="userName" name="userName" maxLength="20"
					placeholder="최대 6자"> <label for="birthday">생년월일</label> <input
					type="text" class="form-control" id="userBithday"
					name="userBirthday" maxLength="20" placeholder="입력형식:20180101">
				...
				</label> <input type="submit" value="가입하기">
			</form>
