...
--게시판 별로 SQL돌려주세요 한번에 하면 COMMIT에서 오류나요 
...
VALUES (BOARD_LIST_SEQ.NEXTVAL, '공지사항', 1, 1);




INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '질문답변게시판', 5, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '사진게시판;인테리어공유', 6, 2);



INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '부동산뉴스', 1, 3);
